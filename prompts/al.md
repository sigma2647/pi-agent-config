...
---
description: 通过追问把问题想的更清楚，同时补上AI更加需要的上下文。
argument-hint: "<苏格拉底式提问>"
---
我的困惑是：$@
...
---
description: 解构产品页面、网页、方案、流程说明、数据看板或其他成品
argument-hint: "反向拆解"
---
我想拆解的优秀范例是：$@。
我想学会的是：【填写你希望从中学会什么】。
...
---
description: 处理路径依赖，直接找到最本质，然后推倒重来。
argument-hint: "<第一性原理>"
---
我想解决的问题是：$@
